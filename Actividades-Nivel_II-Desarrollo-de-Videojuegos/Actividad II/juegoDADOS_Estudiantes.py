...
Fondo=pygame.image.load("C:/Users/user 2/Desktop/Actividad II/dados/fondo1.jpg")
...
imagenes_dados = [pygame.image.load(f"C:/Users/user 2/Desktop/Actividad II/dados/dado{i}.png") for i in range(1, 7)]
...
def evaluar_ronda():
    ...
    if jugador_suma > 10 and cpu_suma > 10:
        resultado = "¡Empate! Ambos se pasaron."
    elif jugador_suma > 10:
        resultado = "¡CPU gana! El jugador se pasó."
    elif cpu_suma > 10:
        resultado = "¡Jugador gana! La CPU se pasó."
